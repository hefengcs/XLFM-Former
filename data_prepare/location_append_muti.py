...
# 定义输入目录和输出目录
input_dir_1 = 'anonymousVCD_dataset/mice/mice1/sub1/input_location_case3'
input_dir_2 = 'anonymousVCD_dataset/mice/mice1/sub1/g'
...
def process_file(filename):
    try:
        ...
        #image_2_resized = np.maximum(image_2_resized, 0)
