...
# 定义输入目录和输出目录
input_dir_1 = 'anonymousVCD_dataset/fixed_fish/240725-03/input'
input_dir_2 = 'anonymousVCD_dataset/fixed_fish/240725-03/g'
output_dir = 'anonymousVCD_dataset/fixed_fish/240725-03/input_location'
