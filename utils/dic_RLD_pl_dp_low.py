...
def main():
    ...
    parser.add_argument('--start_file', type=str, help='The file to start processing from', default="00005884.tif")
    parser.add_argument('--cuda_devices', type=str, help='CUDA visible devices', default='0,1,2,3,4,5,6,7')
    ...
    input_dir = '/gpfs/home/LifeSci/wenlab/hefengcs/VCD_dataset/moving_fish5/split_g/g2'
    output_dir = '/gpfs/home/LifeSci/wenlab/hefengcs/VCD_dataset/moving_fish5/RLD60'
    start_file = args.start_file

    dataset = ReconstructionDataset(input_dir, start_file)
    data_loader = DataLoader(dataset, batch_size=1, shuffle=False, num_workers=8, pin_memory=True, persistent_workers=True, prefetch_factor=8)
