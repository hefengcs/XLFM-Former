...
#用于从2048，2048到600，600，27.
#根据坐标进行裁剪，并且能够减去110的背景噪声
...
def process_image(image_path, lenses_info, output_path):
    ...
    # stacked_images = np.maximum(stacked_images-110, 0)
...
# 输入和输出路径
input_path = '/gpfs/home/LifeSci/wenlab/hefengcs/VCD5.12/stack/input'  # 输入路径
output_path = '/gpfs/home/LifeSci/wenlab/hefengcs/VCD5.12/stack/input_crop'  # 输出路径
coordinates_path = '/gpfs/home/LifeSci/wenlab/hefengcs/VCD_torch_gnode05/utils/coordinates.txt'  # 坐标信息文件路径
